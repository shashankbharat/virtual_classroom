...
<h2 style="text-align: center">
			<span style="font-family: tahoma, geneva, sans-serif"><span style="color: rgb(255,204,102)">Teacher</span><span style="color: rgb(255,160,122)">/Feedback_management/</span><span style="color: rgb(255,140,0)">insert_feedback_question.jsp</span></span></h2>
	


 
	
<form action="insert_feedback_question.jsp" method="post" name="f1">
...
//			con.close();
 ...
 %>
			...
			<p style="text-align: center">
				...
				<input name="insert_feedback_question" size="109" style="width: 198px; height: 24px"  type="submit" value="Proceed to insert question" /></p>
		</form>
